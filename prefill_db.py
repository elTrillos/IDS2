...
print("xdddd")
print(u1.id)
e1=Emprendimiento(id=1,id_usuario=u1.id, nombre="nanai", descripcion="xd pdi", categoria="gente")
e2=Emprendimiento(id=2,id_usuario=u2.id, nombre="puroperkin", descripcion="xd pdi", categoria="autos")
ei1=EmprendimientoImage(id=1,imagename="static/1.jpg", id_emprendimiento=e1.id)
p1=Producto(nombre="prod1",descripcion="El producto uno es xd", disponibilidad=25, precio=5000,id_emprendimiento=e1.id)
...
pi1=ProductImage(id=1,imagename="static/0grs8wpn1wx41.jpg", id_producto=e1.id)
